...
//İçeriği al
$blog_post = @json_decode(file_get_contents("https://public-api.wordpress.com/rest/v1.1/sites/umglbg.wordpress.com/posts/slug:$post_slug"), true);	
//print_r($blog_post);

$id_title = $blog_post['title'];
$title 	= $id_title;
$content = $blog_post['content'];
$s_desc = kisalt($content,160);
$s_desc = strip_tags($s_desc);
$publish_date = $blog_post['date'];
$publish_modified = $blog_post['modified'];
$image = str_replace('umglbg.files.wordpress.com', 'img.umego.io', $blog_post['post_thumbnail']['URL']);
$date = date("F j, Y @ H:i", strtotime($blog_post['date']));

//SEO
$s_title = $title;
$description = $s_desc;
$canonical = "https://umego.io/blog/$post_slug";
...
<meta name="author" content="Nora Lyons">
<meta name="publisher" content="Umego">
...
.subscribe{font-size:45px;font-family:Castoro, serif;line-height: 50px}
.d-none{display:none}
@media (min-width: 768px){
.entry__content p{text-align:justify}
}
</style>
</head>
<body id="top">
...
<header id="masthead" class="s-header">
    <div class="s-header__branding">
        <p class="site-title">
            <a href="https://umego.io" rel="home">
                <img src="https://www.umego.io/logo.png" alt="Umego Logo" width="120">
            </a>
        </p>
    </div>
    ...
    <div class="row s-header__navigation">
        <nav class="s-header__nav-wrap">
            <div class="s-header__nav-heading">Navigate to</div>
            <ul class="s-header__nav">
                <li><a href="https://umego.io" title="">Home</a></li>
                <li><a href="https://umego.io/blog" title="">Blog</a></li>
...
<div id="content" class="s-content s-content--blog">
        <div class="row entry-wrap">
            <div class="column lg-12">
                <article class="entry format-standard" itemscope itemtype="http://schema.org/Article">
                    <meta itemprop="name" content="<?=$title?>">
                    <meta itemprop="headline" content="<?=$title?>">
                    <meta itemprop="datePublished" content="<?=$publish_date?>">
                    ...
                    <div class="d-none" itemprop="author" itemscope itemtype="https://schema.org/Person">
                        <a itemprop="url" href="https://dev.to/noralyons">
                        <span itemprop="name">Nora Lyons</span>
                        </a>
                    </div>

                    <div class="d-none" itemprop="publisher" itemscope itemtype="http://schema.org/Organization">
                        <meta itemprop="name" content="realiqtests.com">
                        <div itemprop="logo" itemscope itemtype="http://schema.org/ImageObject">
                            <meta itemprop="url" content="https://www.umego.io/logo.png">
                        </div>
                    </div>
                        ...
                        <div class="entry__meta">
                            ...
                            <div class="entry__meta-cat">
                                ...
                                <span class="cat-links">
                                    <a href="https://umego.io/blog">Umego Blog</a>
                                </span>
                            </div>
                        </div>
                    </header>
                        ...
                        <div class="entry__content">
                            ...
                            <div class="entry__author-box">
                                <figure class="entry__author-avatar">
                                    <img alt="" src="https://res.cloudinary.com/practicaldev/image/fetch/s--pBCy1DAw--/c_fill,f_auto,fl_progressive,h_320,q_auto,w_320/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/982408/4a34f42f-f56e-4f95-a1e6-d59541d0335e.jpeg" class="avatar">
                                </figure>
...
<footer id="colophon" class="s-footer">
    ...
    <div class="row s-footer__main">
        <div class="column lg-5 md-6 tab-12 s-footer__about">
            <p>
                UMEGO will make it easier to build meaningful relationships through experiences and things you enjoy doing.
            </p>
        </div>
        <div class="column lg-5 md-6 tab-12">
            <div class="row">
                ...
                <div class="column lg-6">
                    <ul class="link-list">
                        <li><a href="https://umego.io">Home</a></li>
                        <li><a href="https://umego.io/blog">Blog</a></li>
    ...
    <div class="row s-footer__bottom">
        ...
        <div class="column lg-5 md-6 tab-12">
            <div class="ss-copyright">
                <span>© Copyright Umego.io 2021 - 2023</span> 
            </div>
        </div>
